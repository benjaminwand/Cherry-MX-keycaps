The ones in the folder ‘with LED’ are 2mm higher so it works if you stick a 3mm LED into the Cherry MX. If you use switches with built-in LED, the ‘without LED’-one might work though.
